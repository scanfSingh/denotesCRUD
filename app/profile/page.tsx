                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700 mono:border-gray-300">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 dark:text-gray-400 mono:text-gray-600">Sign-in Method</p>
                          <p className="text-gray-900 dark:text-white mono:text-black font-medium flex items-center gap-2">
                            {profile.provider === "google" ? (
                              <>
                                Google Account
                                <span className="px-2 py-0.5 text-xs bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded-full">OAuth</span>
                              </>
                            ) : (
                              "Email & Password"
                            )}
